...
public class anaLex {
	...
	public void initLire() {
		...
		ul = (el) i.next(); // initialise l'unité lexicale avec le premier elément de la chaine C (qui
							// existe)
	}// initLire
	...
	public boolean estCaractere(char c) {
		// fonction qui détermine si l'unité courante est le caractère passé en
		// paramètre
	...
	public boolean estFel() {
		// fonction qui détermine si l'unité courante est la marque de fin de chaîne
		// codée
	...
	public void erreur(int noE, String mess) throws MonException {
		...
		switch (noE) {
		case 1: {
			jTextArea2.append("Caractere " + mess + " attendu\n");
			break;
		}
		case 2: {
			jTextArea2.append("Erreur mot clé, ou mot clé " + mess + " attendu\n");
			break;
		}
		case 3: {
			jTextArea2.append("Entier attendu\n");
			break;
		}
		case 4: {
			jTextArea2.append("Identificateur attendu\n");
			break;
		}
		case 5: {
			jTextArea2.append("Fin de programme attendue\n");
			break;
		}
		case 6: {
			jTextArea2.append("\n");
		...
		case 7: {
			jTextArea2.append("Instruction incorrecte\n");
			break;
		}
		case 8: {
			jTextArea2.append("Opérateur relationnel attendu\n");
			break;
		}
		case 9: {
			jTextArea2.append("Opérateur additif attendu\n");
			break;
		}
		case 10: {
			jTextArea2.append("Opérateur multiplicatif attendu\n");
			break;
		}
		case 11: {
			jTextArea2.append("Valeur attendue\n");
			break;
		}
		case 12: {
			jTextArea2.append("Instruction d'entrée/sortie attendue\n");
			break;
		}
		case 13: {
			jTextArea2.append("Il existe du texte après le programme...\n");
			break;
		}
		case 14: {
			jTextArea2.append("Opérateur unaire attendu\n");
			break;
		}
		case 36: {
			jTextArea2.append("Expression incorrecte\n");
			break;
		}
		}
		;
		...
		while (car != ps.ff) {
			...
			if (car == '/') { // début commentaire, /=, ou autre?
				...
				if (car == '/') { // début commentaire
					car = ps.lireSvt();
					noC = noC + 1; // on élimine le reste de la ligne
					while (car != (char) 10) {
						car = ps.lireSvt();
						noC = noC + 1;
					}
